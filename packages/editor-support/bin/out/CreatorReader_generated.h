...
struct SceneGraphBuilder {
  ...
  flatbuffers::Offset<SceneGraph> Finish() {
    auto o = flatbuffers::Offset<SceneGraph>(fbb_.EndTable(start_, 3));
    return o;
  }
};
...
inline flatbuffers::Offset<SceneGraph> CreateSceneGraphDirect(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSceneGraph(_fbb, version ? _fbb.CreateString(version) : 0, root, spriteFrames ? _fbb.CreateVector<flatbuffers::Offset<SpriteFrame>>(*spriteFrames) : 0);
}
