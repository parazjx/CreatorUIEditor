...
Constants.PACKAGE_NAME = 'elestorm-uieditor';
...
Constants.RESOURCE_FOLDER_NAME = 'res';

Constants.EXPORT_DIR = Path.join(Constants.PROJECT_PATH, 'UI-Export')

Constants.VERDION = '2.1.4';

// this default is for build now menu,config in package.json is for build panel
Constants.PROFILE_DEFAULTS = {
    setup: false,
    path: Constants.EXPORT_DIR,
    autoBuild: true,
    exportResourceOnly: true,
    exportResourceDynamicallyLoaded: true
};
